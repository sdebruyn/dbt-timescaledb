...
{% macro timescaledb__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro timescaledb__check_schema_exists(information_schema,schema) -%}
...
{% macro timescaledb__create_schema(relation) -%}
...
{% macro timescaledb__drop_relation(relation) -%}
...
{% macro timescaledb__drop_schema(relation) -%}
...
{% macro timescaledb__get_columns_in_relation(relation) -%}
...
{% macro timescaledb__list_schemas(database) -%}
...
{% macro timescaledb__truncate_relation(relation) -%}
...
{% macro timescaledb__current_timestamp() -%}
